    ...
    return (
      <div className="min-h-screen bg-[url('/images/gallery/bg-cover.jpg')] bg-cover bg-center relative">
        ...
        <nav className="relative z-10 flex items-center justify-between px-6 py-8 md:px-16">
          <h1 className="text-3xl font-bold text-white tracking-widest">Raev Design</h1>
          
          <div className="flex items-center space-x-8">
            <a href="#" className="text-white/90 hover:text-white transition-colors text-lg">HOME</a>
            <a href="#" className="text-white/90 hover:text-white transition-colors text-lg">PRODUCT</a>
            <a href="#" className="text-white/90 hover:text-white transition-colors text-lg">CONTACT US</a>
          </div>
        </nav>
        ...
        <div className="relative z-10 container mx-auto px-6 md:px-16 h-[calc(100vh-120px)] flex items-center justify-center">
          <div className="text-center text-white max-w-4xl">
            <div className="mb-8">
              <p className="text-lg font-semibold tracking-widest mb-4">OFFER FOR BEST INTERIOR</p>
